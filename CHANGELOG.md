...
- Coordinated package metadata, declarations, package smoke tests, CI, and
  dependency audit fixes for the 0.5.0 release.

## [0.4.1] - 2026-04-21

### Added

- Labs status views for the Attestation and Mirror integrations.

## [0.4.0] - 2026-04-20

### Changed

- Conformance badge updated to reflect 256-test / 5-level suite
- Backend version display aligned with OJS v0.4.0 manifest format
- Dependency updates for React 19 compatibility
